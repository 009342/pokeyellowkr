...
BillsMonListText:
	db   $07,$9C,$05,$4A,$07,$9C; RAW DATA : 	db   "이브이"
	next $05,$2E,$06,$4A,$09,$9D; RAW DATA : 	next "부스터"
	next $08,$1A,$0A,$67,$06,$83,$02,$F5; RAW DATA : 	next "쥬피썬더"
	next $05,$CE,$04,$CC,$03,$45; RAW DATA : 	next "샤미드"
