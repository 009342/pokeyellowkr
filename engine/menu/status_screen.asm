...
.DontRecalculate
	...
	call PrintStatusConditionString
	jr nz, .StatusWritten
	coord hl, 16, 6
	ld de, OKText
	call PlaceString ; $8E,$8A
.StatusWritten
	coord hl, 10, 6
	ld de, StatusText
	call PlaceString ; $92,$93,$80,$93,$94,$92,$F3
	;coord hl, 16, 1
...
; if the pokemon's HP is 0, print "FNT"
	...
	ret
FaintText:
	db $01,$B2,$07,$CD,$50; RAW DATA : 	db "기절@"
OTPointers:
	dw wPartyMonOT
	dw wEnemyMonOT
	dw wBoxMonOT
...
PTile: ; This is a single 1bpp $8F
...
StatusScreen2:
	...
	call StatusScreen_PrintPP ; Print $8F,$8F
	ld a, b
	and a
	jr z, .InitPP
	ld c, a
