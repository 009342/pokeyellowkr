...
.placeMoveLearnabilityString
	...
	pop hl
.printLevel
	ld bc,20+5 ; move 10 columns to the right
	add hl,bc
	call PrintLevel
	pop hl
	push hl
	ld bc,5 ; 14 columns to the right
	add hl,bc
...
.checkEvolutionsLoop
	...
	jr z,.placeEvolutionStoneString ; if so, place the $8D,$8E,$93,$7F,$80,$81,$8B,$84
	inc hl
	inc hl
	cp a,EV_ITEM
...
SetPartyMenuHPBarColor:
	...
	call RunPaletteCommand
	;callba HandlePartyHPBarAttributes
