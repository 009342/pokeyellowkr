...
.oldManName
	db $02,$8B,$07,$9E,$50; RAW DATA : 	db "노인@"
.profOakName
...
.partyMonDeselected
	...
	;ld a, " "
	;call FillMemory ;RedrawPartyMenu에서 삭제되므로 상관 ㄴㄴ
	xor a ; NORMAL_PARTY_MENU
	ld [wPartyMenuTypeOrMessageID], a
	call GoBackToPartyMenu
...
DisabledText:
	db $06,$B5,$7F,$06,$26,$7F,$06,$F8,$06,$EE,$0B,$66,$50; RAW DATA : 	db "쓸 수 없어!@"

TypeText:
	db $01,$B2,$06,$2A,$09,$88,$07,$A4,$50 ;기술타입
...
StatsTextStrings:
	db $01,$68,$01,$3D,$03,$F2,$50; RAW DATA : 	db "공격력@"
	db $04,$E6,$06,$EE,$03,$F2,$50; RAW DATA : 	db "방어력@"
	db $06,$4A,$0A,$67,$03,$45,$50; RAW DATA : 	db "스피드@"
	db $09,$DF,$06,$26,$03,$F2,$50; RAW DATA : 	db "특수력@"
	db $04,$8D,$08,$0F,$04,$2C,$50; RAW DATA : 	db "명중률@"
	db $0A,$B8,$0A,$67,$07,$82,$50; RAW DATA : 	db "회피율@"
