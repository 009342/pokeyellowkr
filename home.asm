...
;	rst $38
;SECTION "rst 20", ROM0 [$20] ;작업하던 WRAM 저장 후 01번 뱅크 교체
	; rSVBK=WRAM Adr
	;push af
	;ld a,$01
	;ld [rSVBK],a
...
;SECTION "rst 30", ROM0 [$30];작업하던 WRAM 되돌리기
	;push af
	...
	;ret
	;rst $38
;SECTION "rst 38", ROM0 [$38] ;WRAM뱅크 변경
...
.printItemPrice
	...
	pop hl
	ld bc, 5 ; 1 row down and 5 columns right
	add hl, bc
...
.printItemQuantity
	...
	ld bc, 8+1 ; 1 row down and 8 columns right
	add hl, bc
	ld a, "×"
	ld [hli], a
	ld a, [wd11e]
...
SaveScreenTilesToBuffer2:: ;좀 많이 더러운데, 나중에 고쳐야 할 듯 합니다.
...
;	ld a,$01
;	ld [hV1Enable],a
;	call DelayFrame ;이 부분때문에 한번에 글자를 로딩하는 부분에서 1프레임씩 밀리게 됨. 기존 레드버전의 한글화를 참조해보아야 할 듯
;	pop af
;	ret
TextPredefs::
const_value = 1
