...
; to go to the next set of credits texts.
	...
	db CRED_U_S_COORD, CRED_TILDEN, CRED_NAKAMURA2,CRED_TEXT_FADE
	db CRED_U_S_COORD, CRED_KAWAKAMI, CRED_TEXT
	db CRED_TRANSLATION, CRED_SHOEMAKE, CRED_OSBORNE, CRED_TEXT_FADE
	db CRED_TRANSLATION, CRED_OGASAWARA, CRED_TEXT
