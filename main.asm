INCLUDE "charmap.asm"
INCLUDE "charmap_jp.asm" ;안해주면 unused_names에서 오류납니다.
...
SECTION "bank40",ROMX,BANK[$40] ;한글롬 확장을 위한 프로그램
INCLUDE "hangul/hangul40.asm"

SECTION "bank40_fnt",ROMX[$5000],BANK[$40] ;폰트
INCBIN "hangul/font40.fnt"

SECTION "bank41",ROMX,BANK[$41] ;폰트
INCBIN "hangul/font41.fnt"

SECTION "bank42",ROMX,BANK[$42] ;폰트
INCBIN "hangul/font42.fnt"

;SECTION "bank43",ROMX,BANK[$43] ;폰트, 한글 키보드 입력을 위한 ㅎ
;INCBIN "hangul/font43.fnt"

SECTION "bank50",ROMX,BANK[$50] ;V-blank 확장
INCLUDE "hangul/vblank50.asm"

SECTION "gbc_only", ROMX, BANK[$68]
INCLUDE "engine/gbc_only.asm"

SECTION "code-extend", ROMX, BANK[$60] ;코드확장
INCLUDE "hangul/code60.asm"

SECTION "naming_screen", ROMX, BANK[$70] ;코드확장
